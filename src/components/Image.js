...
import { reset } from '@/common/common'
...
export default class FlexImage extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({ ratio, isLoading, error });
    }
    ...
    render() {
        let _a = this.props, { source, style, onPress, loadingComponent, thumbnail, loadingMethod, errorComponent } = _a, otherProps = reset(_a, ["source", "style", "onPress", "loadingComponent", "thumbnail", "loadingMethod", "errorComponent"]);
        ...
        if (typeof source === 'number') {
            ...
            let { uri, width, height } = source, other = reset(source, ["uri", "width", "height"]);
