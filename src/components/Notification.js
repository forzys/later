...
import { Animated, View, Text, Image, StyleSheet, PanResponder, TouchableWithoutFeedback } from 'react-native';
import configs from '@/common/configs';

let deviceWidth = configs.screen.width
let getStatusBarHeight = configs.getStatusBarHeight 
...
export default class DefaultPopup extends Component {
  ...
  static open(messageConfig){
    this.notificationInstance.show(messageConfig)
  }
